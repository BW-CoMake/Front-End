...
const MyIssue = ({ history, issue, upVote, downVote, editIssue, deleteIssue, getIssueById }) => {
...
export default connect(mapStateToProps, { upVote, downVote, editIssue, deleteIssue, getIssueById })(MyIssue)