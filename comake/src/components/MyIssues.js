...
const MyIssues = ({ history, getUserIssues, issues, upVote, downVote }) => {
            ...
            <Navbar className={classes.navBar} dark>
                ...
                <Collapse isOpen={!collapsed}>
                    <Nav  className={classes.navbar} >
                        ...
                        <NavItem>
                            <NavLink onClick={ () => history.push("/issues") }>Go Back</NavLink>
                        </NavItem>
                        <NavItem>
...
export default connect(mapStateToProps, { getUserIssues, upVote, downVote, editIssue, deleteIssue })(MyIssues)
